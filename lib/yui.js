...
function ExpressYUIExtension(app) {
    ;console.log('~' + __filename.split('/').slice(-2).join('/'), 'ExpressYUIExtension');
    var YUI;
...
ExpressYUIExtension.prototype = {
    ...
    **/
    applyConfig: function () {
        ;console.log('~' + __filename.split('/').slice(-2).join('/'), 'applyConfig');
    ...
    **/
    config: function () {
        ;console.log('~' + __filename.split('/').slice(-2).join('/'), 'config');
