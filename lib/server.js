...
module.exports = {
    ...
    **/
    registerModules: function (groupName, groupModules) {
        ;console.log('~' + __filename.split('/').slice(-2).join('/'), 'registerModules(groupName, groupModules)');
        ;console.log('~  groupName: %s, groupModules: %s', groupName, groupModules);
    ...
    **/
    attachModules: function (groupName, mods) {
        ;console.log('~' + __filename.split('/').slice(-2).join('/'), 'attachModules');
        ;console.log('@groupName: %s, mods: %s', groupName, mods);
        var Y = this._Y;
    ...
    **/
    use: function () {
        ;console.log('~' + __filename.split('/').slice(-2).join('/'), 'use');
