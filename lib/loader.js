...
module.exports = {
    ...
    **/
    register: function (bundleName, cacheKey, mod) {
        ;console.log('~' + __filename.split('/').slice(-2).join('/'), 'register(bundleName, cacheKey, mod)');
        ;console.log('~  bundleName: %s, cacheKey: %s', bundleName, cacheKey);
    ...
    **/
    plugin: function (options) {
        ;console.log('~' + __filename.split('/').slice(-2).join('/'), 'plugin');
        var yui = this,
        ...
        return {
            ...
            bundleUpdated: function (evt, api) {
                ;console.log('~' + __filename.split('/').slice(-2).join('/'), 'bundleUpdated(evt, api)');
                var self = this,
                    bundle = evt.bundle,
                ...
                return api.promise(function (fulfilled, rejected) {
                    ;console.log('~' + __filename.split('/').slice(-2).join('/'), 'bundleUpdated-> return promise');
                    var server,
                        client,
                        serverMeta = {},
                        clientMeta = {},
...
// clientMeta = {
//   "/Users/isao/Repos/modown/express-yui/examples/locator-express/binders/index.js": {
//     "name": "binder-index",
//     "buildfile": "/Users/isao/Repos/modown/express-yui/examples/locator-express/binders/index.js",
//     "builds": {
//       "binder-index": {
//         "name": "binder-index",
//         "config": {
...
//     }
//   },
//   "/Users/isao/Repos/modown/express-yui/examples/locator-express/build/demo/demo-templates-bar.js": {
//     "name": "demo-templates-bar",
//     "buildfile": "/Users/isao/Repos/modown/express-yui/examples/locator-express/build/demo/demo-templates-bar.js",
//     "builds": {
//       "demo-templates-bar": {
//         "name": "demo-templates-bar",
//         "config": {
...
//     }
//   },
//   "/Users/isao/Repos/modown/express-yui/examples/locator-express/build/demo/demo-templates-foo.js": {
//     "name": "demo-templates-foo",
//     "buildfile": "/Users/isao/Repos/modown/express-yui/examples/locator-express/build/demo/demo-templates-foo.js",
//     "builds": {
//       "demo-templates-foo": {
//         "name": "demo-templates-foo",
//         "config": {
...
//     }
//   },
//   "/Users/isao/Repos/modown/express-yui/examples/locator-express/build/demo/demo-templates-index.js": {
//     "name": "demo-templates-index",
//     "buildfile": "/Users/isao/Repos/modown/express-yui/examples/locator-express/build/demo/demo-templates-index.js",
//     "builds": {
...
//     }
//   },
//   "/Users/isao/Repos/modown/express-yui/examples/locator-express/models/alerts-model.js": {
//     "name": "alerts-model",
//     "buildfile": "/Users/isao/Repos/modown/express-yui/examples/locator-express/models/alerts-model.js",
//     "builds": {
//       "alerts-model": {
//         "name": "alerts-model-X",
//         "config": {
...
// clientMeta['/Users/isao/Repos/modown/express-yui/examples/locator-express/models/alerts-model.js'].builds['alerts-model-X'] = 
//     clientMeta['/Users/isao/Repos/modown/express-yui/examples/locator-express/models/alerts-model.js'].builds['alerts-model']
// delete clientMeta['/Users/isao/Repos/modown/express-yui/examples/locator-express/models/alerts-model.js'].builds['alerts-model'];
console.log('*********************');

                    ;console.log('~' + __filename.split('/').slice(-2).join('/'), 'clientMeta =', JSON.stringify(clientMeta, null, 2));

console.log('*********************');

                    ;console.log('~' + __filename.split('/').slice(-2).join('/'), 'client obj 0', JSON.stringify(client, null, 2));
                    client.compile(clientMeta);
                    ;console.log('~' + __filename.split('/').slice(-2).join('/'), 'client.compile(clientMeta).. client =', JSON.stringify(client, null, 2));

                    return api.writeFileInBundle(bundleName, destination_path, client.data.js).then(function (newfile) {
                        ;console.log('~' + __filename.split('/').slice(-2).join('/'), 'bundleUpdated-> return promise -> promise');
                        ;console.log('~  bundleName %s, destination_path %s', bundleName, destination_path);
    ...
    **/
    _buildsInBundle: function (bundle, modifiedFiles, jsonFiles) {
        ;console.log('~' + __filename.split('/').slice(-2).join('/'), '_buildsInBundle(bundle, modifiedFiles, jsonFiles)');
    ...
    **/
    _cssprocInBundle: function (bundle, cssproc) {
        ;console.log('~' + __filename.split('/').slice(-2).join('/'), '_cssprocInBundle(bundle, cssproc)');
        var args = [],
            bundleName = bundle.name,
            config;
    ...
    **/
    _filterFilesInBundle: function (bundle, list, filter) {
        ;console.log('~' + __filename.split('/').slice(-2).join('/'), '_filterFilesInBundle(bundle, list, filter)');
        var files = [];
