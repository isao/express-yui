...
module.exports = {
    ...
    **/
    addModuleToSeed: function (moduleName, groupName) {
        ;console.log('~' + __filename.split('/').slice(-2).join('/'), 'addModuleToSeed(moduleName, groupName)');
        ;console.log('~  moduleName: %s, groupName: %s', moduleName, groupName);
    ...
    **/
    seed: function (modules) {
        ;console.log('~' + __filename.split('/').slice(-2).join('/'), 'seed(modules)');
    ...
    **/
    getSeedUrls: function (customConfig) {
        ;console.log('~' + __filename.split('/').slice(-2).join('/'), 'getSeedUrls');
        var config = this.config(),
    ...
    **/
    buildJSUrls: function () {
        ;console.log('~' + __filename.split('/').slice(-2).join('/'), 'buildJSUrls');
    ...
    **/
    buildCSSUrls: function () {
        ;console.log('~' + __filename.split('/').slice(-2).join('/'), 'buildCSSUrls');
    ...
    **/
    _buildUrls: function (modules, ext, filterMap, customConfig) {
        ;console.log('~' + __filename.split('/').slice(-2).join('/'), '_buildUrls');
        ...
        function flush() {
            ;console.log('~' + __filename.split('/').slice(-2).join('/'), 'flush');
            if (stack.length > 0) {
        ...
        function isSimilarGroup(newGroup) {
            ;console.log('~' + __filename.split('/').slice(-2).join('/'), 'isSimilarGroup');
